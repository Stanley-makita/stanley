-- Recria as três funções de emissão com DROP explícito.
-- CREATE OR REPLACE não permite mudar nomes de colunas de retorno em RETURNS TABLE.
-- Se a migration 101 falhou no resumo_estoque, as demais funções também podem não existir.
