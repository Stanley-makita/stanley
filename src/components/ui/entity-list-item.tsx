...
export function EntityListItem({
  ...
  return (
    <button
      type="button"
      className={cn(
        'group flex w-full items-center gap-4 rounded-lg border border-gray-100 bg-white px-4 py-3.5 text-left transition-all hover:border-[#253B29]/30 hover:shadow-sm',
        className
      )}
      {...props}
    >
